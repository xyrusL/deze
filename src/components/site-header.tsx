  ...
  return (
    ...
    >
      ...
      >
        ...
        <ul className="grid w-full grid-cols-2 gap-1.5 rounded-[1.5rem] border border-black/5 bg-black/[0.03] p-1.5 text-sm font-medium text-zinc-600 dark:border-white/10 dark:bg-black/20 dark:text-zinc-300 sm:flex sm:w-auto sm:flex-wrap sm:justify-end sm:gap-2 sm:rounded-full sm:border-0 sm:bg-transparent sm:p-0">
          {items.map((item) => {
