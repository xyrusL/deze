...
export function ProjectCard({ index, project, onOpen }: ProjectCardProps) {
  ...
  return (
    <button
      className="hover-lift-soft hover-shadow-premium hover-card-premium hover-press-soft group flex min-h-[15rem] min-w-0 snap-start flex-col gap-6 overflow-hidden rounded-[1.6rem] border border-zinc-200/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(244,244,245,0.9))] p-5 text-left shadow-sm hover:border-sky-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-500 dark:border-white/10 dark:bg-[linear-gradient(180deg,rgba(24,24,27,0.82),rgba(9,9,11,0.62))] dark:hover:border-sky-300/20 sm:h-full sm:min-h-[17rem]"
      ...
      <div className="space-y-4">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 space-y-3">
            ...
            <h3 className="hover-text-glide text-xl leading-tight font-semibold tracking-tight text-balance text-zinc-950 dark:text-white sm:text-lg">
              {project.shortName}
            </h3>
          </div>
        ...
        <p className="project-card-description break-words text-sm leading-6 text-zinc-600 dark:text-zinc-300">
          {project.description}
        </p>
      </div>
