...
export function ProjectCard({ index, project, onOpen }: ProjectCardProps) {
  ...
  return (
    <article className="group flex min-h-[15rem] min-w-0 snap-start flex-col gap-6 overflow-hidden rounded-[1.6rem] border border-zinc-200/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(244,244,245,0.9))] p-5 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-sky-200 hover:shadow-[0_18px_35px_rgba(56,189,248,0.12)] dark:border-white/10 dark:bg-[linear-gradient(180deg,rgba(24,24,27,0.82),rgba(9,9,11,0.62))] dark:hover:border-sky-300/20 sm:h-full sm:min-h-[17rem]">
