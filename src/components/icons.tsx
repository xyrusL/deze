...
export const PhilippinesFlagIcon = createIcon(
  <>
    <clipPath id="ph-flag-shape">
      <rect x="4" y="6" width="16" height="12" rx="2.5" />
    </clipPath>
    <g clipPath="url(#ph-flag-shape)">
      <rect x="8" y="6" width="12" height="6" fill="currentColor" opacity="0.95" />
      <rect x="8" y="12" width="12" height="6" fill="#ef4444" />
      <path d="M4 6l8 6-8 6V6Z" fill="#fffdf7" />
      <circle cx="7" cy="12" r="1.4" fill="#fbbf24" />
      <circle cx="6" cy="8.4" r="0.6" fill="#fbbf24" />
      <circle cx="6" cy="15.6" r="0.6" fill="#fbbf24" />
      <circle cx="9.5" cy="12" r="0.6" fill="#fbbf24" />
    </g>
    <rect
      x="4"
      y="6"
